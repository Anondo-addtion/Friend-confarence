// -------------------------------------------------------------
    ...
    // -------------------------------------------------------------
    // 2. WEBSOCKET CONNECTION WITH PING-PONG & AUTH GUARD
    // -------------------------------------------------------------
    async function startConnection() {
      ...
      if (!username || !password) {
        showAlert("অনুগ্রহ করে আপনার নাম এবং রুম পাসওয়ার্ড দিন।");
        return;
      }
      ...
      loginBtnIcon.className = "fa-solid fa-circle-notch fa-spin text-xs";
      ...
      try {
        ...
        resetLoginBtn();
        showAlert("সার্ভার কানেকশন তৈরি করতে সমস্যা হয়েছে!");
        return;
      }

      socket.addEventListener('open', () => {
        // কানেকশন ওপেন হলেও লগইন মোডাল হাইড করব না, সার্ভিস রোল/অথ মেসেজ চেক করব
        startPingPong();
      });
      ...
      socket.addEventListener('message', async (event) => {
        try {
          ...
          if (data.system) {
            // পাসওয়ার্ড সঠিক হলে এবং ভূমিকা পাওয়ার পর মোডাল বন্ধ হবে
            if (data.type === 'role_assign') {
              resetLoginBtn();
              loginModal.classList.add('hidden'); // সফল লগইন হলেই মোডাল সরানো হবে
      ...
      socket.addEventListener('close', (e) => {
        ...
        if (e.code === 4003) {
          ...
          showAlert("❌ ভুল পাসওয়ার্ড! অনুগ্রহ করে সঠিক পাসওয়ার্ড দিন।");
        } else {
    ...
    // Ping-Pong Heartbeat Functionality (২০ সেকেন্ড পর পর ব্যাকগ্রাউন্ডে কল পাঠাবে)
    ...
    function resetLoginBtn() {
      ...
      loginBtnIcon.className = "fa-solid fa-arrow-right text-xs";
      loginStatusMsg.classList.add('hidden');
    }
